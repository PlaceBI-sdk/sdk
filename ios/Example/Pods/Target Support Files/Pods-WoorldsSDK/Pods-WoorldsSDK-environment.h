...
// WoorldsSDK
#define COCOAPODS_POD_AVAILABLE_WoorldsSDK
#define COCOAPODS_VERSION_MAJOR_WoorldsSDK 0
#define COCOAPODS_VERSION_MINOR_WoorldsSDK 1
#define COCOAPODS_VERSION_PATCH_WoorldsSDK 1
